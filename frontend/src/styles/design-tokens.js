// Design System Tokens - Premium SaaS UI
export const designTokens = {
  ...
  // Gradients - Modern SaaS style
  gradients: {
    primary: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
    blue: 'linear-gradient(135deg, #0ea5e9 0%, #0284c7 100%)',
    purple: 'linear-gradient(135deg, #d946ef 0%, #a21caf 100%)',
...
export const getGradient = (gradientName) => {
  return designTokens.gradients[gradientName] || gradientName;
};
